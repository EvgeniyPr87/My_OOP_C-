// #8 ѕроектируйте свои классы так, чтобы их было сложно использовать неправильно
#include<iostream>
using std::cout;
using std::cin;
using std::endl;
...
class Day
{
	int day;
public:
	//функци€ провер€ет вхождение в диапазон даты
	bool is_valid()const
	{
		return day > 0 && day < 32;
	}
public:
	//класс неверный день
	class InvalidDay {};
	// в конструкторе провер€ем €вл€етс€ дата верной
